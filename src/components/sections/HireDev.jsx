  ...
  return (
    <>
      <div className="hero-box overflow-hidden">
        ...
        <a href="/hireDevelopers" class="hero-btn text-decoration-none btn-animation">
          <span class="fs-20 fw-500 text-white">Developer Profile</span>
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="18" cy="18" r="18" fill="#F4F4F4"></circle>
            <path d="M12 18L24 18" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          </path>
          <path d="M19 12.75L24.25 18L19 23.25" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            </path>
            </svg>
            </a>
      </div>
